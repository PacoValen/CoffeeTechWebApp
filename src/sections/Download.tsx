    ...
    <>
      ...
      <section className="flex flex-col items-center justify-center px-4 py-12 bg-white md:px-8 md:py-16">
        <div className="max-w-xl md:max-w-2xl mx-auto text-center">
          ...
          {/* Botón visible solo en dispositivos móviles/tablets */}
          <a
            href="/coffeeTech.apk"
            className="inline-flex items-center justify-center w-full sm:w-auto px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg 
            font-medium text-white bg-green-600 rounded-full hover:bg-green-700 focus:outline-none focus:ring-2 
            focus:ring-green-500 focus:ring-offset-2 transition-colors duration-300 lg:hidden"
          ...
          <p className="hidden lg:block mt-6 text-lg text-gray-600">
            La descarga de la aplicación está disponible solo desde un dispositivo móvil o tablet.
          </p>

          <p className="mt-6 text-xs sm:text-sm text-gray-500">
            Versión 4.1.4 - Última actualización: Noviembre 2024
          </p>
        </div>
      </section>
      <Footer2 />
