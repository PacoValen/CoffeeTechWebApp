      ...
      <Nav2 />
        <section className="flex flex-col items-center justify-center px-4 py-12 bg-white md:px-8 md:py-16">
            <div className="max-w-xl md:max-w-2xl mx-auto text-center">
              ...
              <a
                href="/app-debug.apk"
                className="inline-flex items-center justify-center w-full sm:w-auto px-6 py-3 sm:px-8 sm:py-4 text-base sm:text-lg font-medium text-white bg-amber-500 rounded-full hover:bg-amber-600 focus:outline-none focus:ring-2 focus:ring-amber-400 focus:ring-offset-2 transition-colors duration-300"
